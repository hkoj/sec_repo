...
-   select har mange triks.
    Man kan endre rekkefølgen på kolonnen
...
-   kan også endre variabelnavn ved hjelp av select.
    dette kan en gjøre samtidig som en sortere variablene

    select(model, vekt = wt, everything())

-   Det som skrives inne i en Pipe, vil ikke bli lagret som et datasett.
    Dersom en ønsker å ta vare på Pipen og kanskje bruke oppsettet i andre chunker, må vi legge det inn i et nytt datasett på følgende måte helt i starten av chunken
